...
NeRF 主题的资源分散在项目三大类目录中：**论文源码 + 中文教程 + 参考实现**三位一体。

## 资源分布

```
RoboTwinTutorial/
├── papers/nerf/latex/     论文 LaTeX 源码（arxiv_submission.tex 为入口）
├── tutorials/nerf/        详细中文教程（10 章，从入门到实战，本目录）
└── projects/nerf/         最小可运行 PyTorch 参考实现（含演示数据脚本与测试）
```
...
| 想做什么 | 去哪里 |
|---------|--------|
| 了解论文讲了什么 | [教程导航](README.md)（先读导航） |
| 推导核心公式 | [03_数学原理与渲染方程](03_数学原理与渲染方程.md) |
| 读懂网络结构 | [04_网络架构与位置编码](04_网络架构与位置编码.md) |
| 读懂实验与消融 | [06_数据集与实验结果](06_数据集与实验结果.md) |
| 跑代码 | [项目说明](../../projects/nerf/README.md) |
| 代码与公式对应 | [09_代码逐行精读](09_代码逐行精读.md) |

## 论文源码（papers/nerf/latex/）

- 主文件：`papers/nerf/latex/arxiv_submission.tex`
